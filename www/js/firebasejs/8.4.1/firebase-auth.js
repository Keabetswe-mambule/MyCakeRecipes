  ...
  try {
    !function () {
      ...
      !function () {
            ...
            if (r)
              for (
                var t = function (t, e, n) {
                    r--,
                      (o[t] = e ? { Pb: !0, value: n } : { Pb: !1, reason: n }),
                      0 == r && i(o);
                  },
                  e = 0;
                e < n.length;
        ...
        (Pe.prototype.xa = !(De.prototype.name = "cancel")),
        ...
        function Je(t, e) {
          ...
          n in t.a &&
            G(t.a[n], e) &&
            (We(e), 0 == t.a[n].length && (delete t.a[n], t.b--));
        }
        function Ye(t, e, n, i) {
          for (var r = 0; r < t.length; ++r) {
            var o = t[r];
            if (!o.va && o.listener == e && o.capture == !!n && o.Va == i)
              return r;
          }
          return -1;
        }
        Xe.prototype.add = function (t, e, n, i, r) {
          ...
          return (
            -1 < a
              ? ((e = t[a]), n || (e.Pa = !1))
              : (((e = new Be(e, this.src, o, !!i, r)).Pa = n), t.push(e)),
            e
          );
        };
        ...
        function Qe(t, e, n, i, r, o) {
          ...
          var a,
            ...
            u = m(r) ? !!r.capture : !!r,
            c = un(t);
          if ((c || (t[ze] = c = new Xe(t)), !(n = c.add(e, n, i, u, o)).proxy))
            if (
              ((a = sn),
              (i = s = je
                ? function (t) {
            ...
            ((e = t.src) && e[Ke]
              ...
              : ((n = t.type),
                ...
                e.removeEventListener
                  ...
                  : e.detachEvent
                  ? e.detachEvent(rn(n), i)
                  : e.addListener && e.removeListener && e.removeListener(i),
                (n = un(e))
                  ? (Je(n, t), 0 == n.b && ((n.src = null), (e[ze] = null)))
                  : We(t)));
        }
        function rn(t) {
        ...
        w(ln, Pe),
          (ln.prototype[Ke] = !0),
          (ln.prototype.addEventListener = function (t, e, n, i) {
            Ze(this, t, e, n, i);
          }),
          ...
          (ln.prototype.dispatchEvent = function (t) {
            var e;
            if ((n = this.gb)) for (e = []; n; n = n.gb) e.push(n);
            var n = this.ac,
              i = t.type || t;
            if (
              ("string" == typeof t
                ...
                : t instanceof Fe
                ? (t.target = t.target || n)
                : ((a = t), lt((t = new Fe(i, n)), a)),
              (a = !0),
              e)
            )
              for (var r = e.length - 1; 0 <= r; r--)
                var o = (t.b = e[r]), a = pn(o, i, !0, t) && a;
            if (
              ((a = pn((o = t.b = n), i, !0, t) && a),
              (a = pn(o, i, !1, t) && a),
              e)
            )
          ...
          (ln.prototype.Da = function () {
            if ((ln.ab.Da.call(this), this.v)) {
              var t,
                e = this.v;
              for (t in e.a) {
                for (var n = e.a[t], i = 0; i < n.length; i++) We(n[i]);
                delete e.a[t], e.b--;
              }
            }
            this.gb = null;
        ...
        function Cn(t, e, n, i) {
          ...
          return (
            t && An(r, t), e && (r.a = e), n && kn(r, n), i && (r.f = i), r
          );
        }
        function Rn(t, e) {
          return t
        ...
        (En.prototype.toString = function () {
          ...
          return (
            ...
            (n = this.f) &&
              ...
              t.push(Dn(n, "/" == n.charAt(0) ? Mn : xn, !0))),
            (n = this.b.toString()) && t.push("?", n),
            (n = this.h) && t.push("#", Dn(n, Un)),
            t.join("")
          );
        }),
        ...
        function Gn(t, e, n) {
          Hn(t, e),
            0 < n.length &&
              ((t.c = null), t.a.set(Wn(t, e), X(n)), (t.b += n.length));
        }
        function Bn(t) {
          var e = new Vn();
        ...
        ((t = Vn.prototype).add = function (t, e) {
          ...
          (t.Y = function () {
            Fn(this);
            for (
              var t = this.a.W(), e = this.a.Y(), n = [], i = 0;
              i < e.length;
              i++
            )
          ...
          (t.W = function (t) {
            ...
            var e = [];
            if ("string" == typeof t)
              Kn(this, t) && (e = W(e, this.a.get(Wn(this, t))));
            else {
              t = this.a.W();
          ...
          (t.set = function (t, e) {
            return (
              Fn(this),
              (this.c = null),
              Kn(this, (t = Wn(this, t))) && (this.b -= this.a.get(t).length),
              this.a.set(t, [e]),
              (this.b += 1),
              this
            );
        ...
        function ei(t) {
          return !!(
            (t = (t || gi()).toLowerCase()).match(/android/) ||
            t.match(/webos/) ||
        ...
        var vi = { md: "FirebaseCore-web", od: "FirebaseUI-web" };
        function mi(t, e) {
          e = e || [];
          var n,
            i = [],
            r = {};
          for (n in vi) r[vi[n]] = !0;
        ...
        function Fi(t, e) {
          if (e) for (var n in e) e.hasOwnProperty(n) && Vi(t, n, e[n]);
        }
        function qi(t) {
          var e = {};
          return Fi(e, t), e;
        ...
        function Ki(t) {
          ...
          Vi(
            this,
            "enrollmentTime",
            (n = t[Wi] ? new Date(t[Wi]).toUTCString() : n)
          ),
            Vi(this, "factorId", e);
        }
        function Gi(t) {
        ...
        function zi(t) {
          ...
          r == Qi
            ? ((e[or] = n || null), (e[sr] = n || null), (e[rr] = i))
            : ((e[or] = i || null), (e[sr] = i || null), (e[rr] = n || null)),
            (e[ar] = t || null),
            Vi(this, cr, r),
            Vi(this, ur, Hi(e));
        }
          ...
          if (
            ...
            if ("string" == typeof e && e.length) {
              if (((this.a = e), void 0 !== n && "boolean" != typeof n))
                throw new T(
                  "argument-error",
                  kr + " property must be a boolean when specified."
                );
              if (
                ((this.g = !!n),
                void 0 !== i &&
            ...
            throw new T(
              "argument-error",
              wr + " property must be a non null object when specified."
            );
          if (((this.f = null), (e = t[Er]) && "object" == typeof e)) {
            if ("string" == typeof (e = e[_r]) && e.length) this.f = e;
            else if (void 0 !== e)
              throw new T(
                "argument-error",
            ...
            throw new T(
              "argument-error",
              Er + " property must be a non null object when specified."
            );
          if (void 0 !== (e = t[Tr]) && "boolean" != typeof e)
            throw new T(
              "argument-error",
              Tr + " property must be a boolean when specified."
            );
          if (
            ((this.c = !!e),
            void 0 !== (t = t[Ir]) &&
            ...
            throw new T(
              "argument-error",
              Ir + " property must be a non empty string when specified."
            );
          this.i = t || null;
        }
        var wr = "android",
        ...
        var xr = "oauth_consumer_key oauth_nonce oauth_signature oauth_signature_method oauth_timestamp oauth_token oauth_version".split(
          ...
          jr = {
            nd: { Ja: "locale", ua: 700, ta: 600, fa: "facebook.com", Xa: Mr },
            pd: { Ja: null, ua: 500, ta: 750, fa: "github.com", Xa: Mr },
            qd: { Ja: "hl", ua: 515, ta: 680, fa: "google.com", Xa: Mr },
            wd: { Ja: "lang", ua: 485, ta: 705, fa: "twitter.com", Xa: xr },
            kd: { Ja: "locale", ua: 640, ta: 600, fa: "apple.com", Xa: [] },
          };
        function Ur(t) {
          for (var e in jr) if (jr[e].fa == t) return jr[e];
          return null;
        }
        function Vr(t) {
          var e = {};
        ...
        function Hr(t) {
          var e,
            n = t[qr];
          if ((n || !t[Fr] || ((e = Pr(t[Fr])) && e.b && (n = e.b)), !n))
          ...
          ("anonymous" != n && "custom" != n) || (n = null),
            ...
            Vi(this, "providerId", n),
            Vi(this, "isNewUser", e);
        }
        function Kr(t) {
          Hr.call(this, t),
            Vi(this, "profile", Hi((t = Si(t.rawUserInfo || "{}")) || {}));
        }
        function Gr(t) {
          if ((Kr.call(this, t), "facebook.com" != this.providerId))
            throw Error("Invalid provider ID!");
        }
        function Br(t) {
          if ((Kr.call(this, t), "github.com" != this.providerId))
            throw Error("Invalid provider ID!");
          Vi(this, "username", (this.profile && this.profile.login) || null);
        }
        function Wr(t) {
          if ((Kr.call(this, t), "google.com" != this.providerId))
            throw Error("Invalid provider ID!");
        }
        function Xr(t) {
          if ((Kr.call(this, t), "twitter.com" != this.providerId))
            throw Error("Invalid provider ID!");
        ...
        function io(t, e, n) {
          if (((this.a = null), e.idToken || e.accessToken))
            e.idToken && Vi(this, "idToken", e.idToken),
              e.accessToken && Vi(this, "accessToken", e.accessToken),
              e.nonce && !e.pendingToken && Vi(this, "nonce", e.nonce),
              e.pendingToken && (this.a = e.pendingToken);
          else {
            if (!e.oauthToken || !e.oauthTokenSecret)
              throw new T("internal-error", "failed to construct a credential");
            Vi(this, "accessToken", e.oauthToken),
              Vi(this, "secret", e.oauthTokenSecret);
          }
        ...
        function ao(t, e) {
          (this.Qc = e || []),
            Fi(this, { providerId: t, isOAuthProvider: !0 }),
            (this.Ib = {}),
            (this.pb = (Ur(t) || {}).Ja || null),
            (this.ob = null);
        }
        function so(t) {
        ...
        function ho(t) {
          ...
          var e = t;
          return (
            m(t) && (e = t.accessToken), new co().credential({ accessToken: e })
          );
        }
        function lo() {
        ...
        function fo(t) {
          ...
          var e = t;
          return (
            m(t) && (e = t.accessToken), new lo().credential({ accessToken: e })
          );
        }
        function po() {
        ...
        function vo(t, e) {
          ...
          return (
            ...
            new po().credential({ idToken: n, accessToken: e })
          );
        }
        function mo() {
        ...
        function wo() {
          Fi(this, { providerId: "password", isOAuthProvider: !1 });
        }
        function Io(t, e) {
          if (!(e = To(e)))
        ...
        function Eo(t) {
          ...
          (this.a = t),
            Vi(this, "providerId", "phone"),
            (this.fa = "phone"),
            Vi(this, "signInMethod", "phone");
        }
        function Ao(e) {
          if (
            e &&
        ...
        function No(t, e) {
          ...
          return new Eo({ eb: t, cb: e });
        }
        function _o(t) {
          if (t.temporaryProof && t.phoneNumber)
            return new Eo({ La: t.temporaryProof, ea: t.phoneNumber });
        ...
        (Yr.prototype.Ha = function () {
          ...
          w(co, uo),
          Vi(co, "PROVIDER_ID", "facebook.com"),
          Vi(co, "FACEBOOK_SIGN_IN_METHOD", "facebook.com"),
          w(lo, uo),
          Vi(lo, "PROVIDER_ID", "github.com"),
          Vi(lo, "GITHUB_SIGN_IN_METHOD", "github.com"),
          w(po, uo),
          Vi(po, "PROVIDER_ID", "google.com"),
          Vi(po, "GOOGLE_SIGN_IN_METHOD", "google.com"),
          w(mo, ao),
          Vi(mo, "PROVIDER_ID", "twitter.com"),
          Vi(mo, "TWITTER_SIGN_IN_METHOD", "twitter.com"),
          ...
          Fi(wo, { PROVIDER_ID: "password" }),
          Fi(wo, { EMAIL_LINK_SIGN_IN_METHOD: "emailLink" }),
          Fi(wo, { EMAIL_PASSWORD_SIGN_IN_METHOD: "password" }),
          ...
          (So.prototype.fb = function (i, r) {
            var o = this.a.a;
            return ye(r.verify()).then(function (n) {
              if ("string" != typeof n)
                throw new T(
                  "argument-error",
                  ...
                  t && t.type == zr
                    ...
                    ? t.Ha().then(function (t) {
                        return (
                          ...
                          Xs(e, js, t).then(function (t) {
                            return t.phoneResponseInfo.sessionInfo;
                          })
                        );
                        var e;
                      })
                    : Xs(o, Ds, { phoneNumber: e, recaptchaToken: n });
              return t.then(
                function (t) {
          ...
          Fi(So, { PROVIDER_ID: "phone" }),
          Fi(So, { PHONE_SIGN_IN_METHOD: "phone" }),
        ...
        function Mo(t, e, n) {
          T.call(this, t, n),
            (t = e || {}).Jb && Vi(this, "email", t.Jb),
            t.ea && Vi(this, "phoneNumber", t.ea),
            t.credential && Vi(this, "credential", t.credential),
            t.Zb && Vi(this, "tenantId", t.Zb);
        }
        function jo(t) {
          if (t.code) {
            var e = t.code || "";
            0 == e.indexOf(k) && (e = e.substring(k.length));
            var n = { credential: _o(t), Zb: t.tenantId };
        ...
        w(xo, T),
          ...
          (Bo.prototype.a = null),
          (Bo.prototype.reset = function (t, e, n, i, r) {
            delete this.a;
          }),
        ...
        function ea(t) {
          var e, n, i;
          return (
            ta || ((ta = new Wo("")), ((Qo[""] = ta).c = zo)),
            (e = Qo[t]) ||
              ((e = new Wo(t)),
              (i = t.lastIndexOf(".")),
              (n = t.substr(i + 1)),
              (i = ea(t.substr(0, i))).b || (i.b = {}),
              ((i.b[n] = e).a = i),
              (Qo[t] = e)),
            e
          );
        ...
        function ra(t) {
          ln.call(this),
            ...
            (this.f = ""),
            (this.a = !1),
            (this.i = ea("goog.net.FetchXmlHttp")),
        ...
        function da(e, t, n, i, r) {
          ...
          (n = n ? n.toUpperCase() : "GET"),
            ...
            (e.c = !0),
            (e.a = (e.D || Po).a()),
            (e.C = e.D ? Vo(e.D) : Vo(Po)),
            (e.a.onreadystatechange = b(e.Vb, e));
          try {
            na(e.b, Ta(e, "Opening Xhr")),
              (e.O = !0),
              e.a.open(n, String(t), !0),
              (e.O = !1);
          } catch (t) {
            return (
              na(e.b, Ta(e, "Error opening Xhr: " + t.message)), void va(e, t)
            );
          }
          t = i || "";
          var o,
          ...
          r &&
            (function (t, e) {
              if (t.forEach && "function" == typeof t.forEach)
                ...
                for (var n = bn(t), i = gn(t), r = i.length, o = 0; o < r; o++)
        ...
        function ga(e) {
          if (e.c && void 0 !== h)
            if (e.C[1] && 4 == wa(e) && 2 == Ia(e))
              na(e.b, Ta(e, "Local request error detected and ignored"));
            else if (e.i && 4 == wa(e)) vn(e.Vb, 0, e);
            else if ((e.dispatchEvent("readystatechange"), 4 == wa(e))) {
        ...
        function _a(e) {
          ...
          e.h &&
            ...
            Na(e) &&
            ((i = e.h),
            (n = Da[i]) && (l.clearTimeout(n.a), delete Da[i]),
            (e.h = 0)),
          ...
          (e.c = i),
            t &&
              ((s = b(e.m, e, !0)),
              (t = b(e.m, e, !1)),
              i instanceof Ea ? (Sa(i, s, t), (i.C = !0)) : i.then(s, t)),
            n && ((i = new Ra(i)), (Da[i.a] = i), (e.h = i.a));
        }
        function Oa() {
          C.call(this);
        }
        ...
        ((t = ca.prototype).Ma = function () {
          ...
          (Ea.prototype.then = function (t, e, n) {
            ...
            return (
              Sa(this, i, function (t) {
                t instanceof Ca ? o.cancel() : r(t);
              }),
              o.then(t, e, n)
            );
          }),
          (Ea.prototype.$goog_Thenable = !0),
          w(Oa, C),
          (Oa.prototype.message = "Deferred has already fired"),
          (Oa.prototype.name = "AlreadyCalledError"),
          w(Ca, C),
        ...
        function Fa(t, e, n) {
          if (
            ...
            (this.m = t.secureTokenTimeout || Ka),
            (this.g = ct(t.secureTokenHeaders || Ga)),
            (this.h =
              t.firebaseEndpoint ||
            ...
            (this.v = t.firebaseTimeout || Ba),
            (this.a = ct(t.firebaseHeaders || Wa)),
            n &&
            ...
            !(n =
              ...
              (n &&
                ...
                zl.default.INTERNAL.node.XMLHttpRequest)) && !ci())
          )
            throw new T(
              "internal-error",
        ...
        function Ja(t, e) {
          e &&
            ((t.l = Ya("https://securetoken.googleapis.com/v1/token", e)),
            (t.h = Ya(
              "https://www.googleapis.com/identitytoolkit/v3/relyingparty/",
              e
            )),
            (t.i = Ya("https://identitytoolkit.googleapis.com/v2/", e)));
        }
        function Ya(t, e) {
          return (
            (t = On(t)),
                    ...
                    JSON.parse(
                      (function (e) {
                        try {
                          ...
                          return (
                            na(e.b, "Can not get responseText: " + t.message),
                            ""
                          );
                        }
                      })(this)
        ...
        function ts(t, e, n, i, r, o, a) {
          ...
          var u = "GET" == i;
          if (u) for (var c in r) r.hasOwnProperty(c) && Nn(s, c, r[c]);
        ...
        function es(t) {
          if ("string" != typeof (t = t.email) || !oi.test(t))
        ...
        function cs(t) {
          ...
          if (
            (t.needConfirmation
              ...
              ? ((t.code = "credential-already-in-use"), (e = jo(t)))
              : "EMAIL_EXISTS" == t.errorMessage
              ? ((t.code = "email-already-in-use"), (e = jo(t)))
        ...
        ((t = Fa.prototype).Db = function (t, i) {
          ...
          (t.nb = function (t, e) {
            return Xs(this, Rs, { oobCode: t, newPassword: e });
          }),
          (t.Ra = function (t) {
        ...
        var ps = { endpoint: "setAccountInfo", A: ds, Z: "email", B: !0 },
          vs = {
          ...
          return ye(n)
            ...
            .then(function () {
              return (
                ...
                ts(t, r ? t.i : t.h, e.endpoint, o, n, e.Hb, e.lb || !1)
              );
            })
            .then(function (t) {
                ...
                new fe(function (t, e) {
                  ...
                  bi("gapi.iframes.Iframe")
                    ...
                    : ((i =
                      ...
                      ye(Pa((i = It($s, { onload: i })))).o(function () {
        ...
        function eu(t, e, n, i) {
          (this.l = t),
            ...
            (this.f = null),
            (t = this.g
              ? Cn((t = On(this.g.url)).c, t.a, t.g, "/emulator/auth/iframe")
              : Cn("https", this.l, null, "/__/auth/iframe")),
            (this.a = t),
            Nn(this.a, "apiKey", this.h),
            Nn(this.a, "appName", this.i),
            (this.b = null),
            (this.c = []);
        }
        ...
        function au(r) {
          return (
            r.m ||
            ((r.m = ai().then(function () {
              var t, e, n, i;
              r.u ||
                ((t = r.c),
                (e = r.i),
                (n = iu(r.b)),
                ((i = new eu(r.s, r.g, r.b, r.f)).f = t),
                (i.b = e),
                (i.c = X(n || [])),
                (r.u = i.toString())),
                (r.v = new zs(r.u)),
                  ...
                  !(function (t, e) {
                    t.rb.then(function () {
                      t.a.register(
                        "authEvent",
                        e,
                        bi("gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER")
                      );
                    });
                  })(i.v, function (t) {
                    var e = {};
        ...
        function su(t) {
          return (
            t.l ||
              ((t.C = t.c ? mi(t.c, iu(t.b)) : null),
              (t.l = new Fa(t.g, _(t.i), t.C)),
              t.f && Ja(t.l, t.f)),
            t.l
          );
        }
        ...
        (eu.prototype.toString = function () {
          return (
            this.f ? Nn(this.a, "v", this.f) : Hn(this.a.b, "v"),
            this.b ? Nn(this.a, "eid", this.b) : Hn(this.a.b, "eid"),
            this.c.length
              ? Nn(this.a, "fw", this.c.join(","))
              : Hn(this.a.b, "fw"),
            this.a.toString()
          );
        }),
            ...
            if (
              (Nn(
                (t = this.v
                  ...
                  : Cn("https", this.u, null, "/__/auth/handler")),
                "apiKey",
                this.s
              ),
              Nn(t, "appName", this.c),
              Nn(t, "authType", this.m),
              ...
              for (i in ((e.ob = n),
              Nn(t, "providerId", this.a.providerId),
              (e = ki((n = this.a).Ib))))
                e[i] = e[i].toString();
              ...
              n.pb && n.ob && !e[n.pb] && (e[n.pb] = n.ob),
                ut(e) || Nn(t, "customParameters", Ai(e));
            }
            if (
              ("function" == typeof this.a.Qb &&
                (n = this.a.Qb()).length &&
                Nn(t, "scopes", n.join(",")),
              this.l ? Nn(t, "redirectUrl", this.l) : Hn(t.b, "redirectUrl"),
              this.g ? Nn(t, "eventId", this.g) : Hn(t.b, "eventId"),
              this.i ? Nn(t, "v", this.i) : Hn(t.b, "v"),
              this.b)
            )
              for (var a in this.b)
                this.b.hasOwnProperty(a) && !_n(t, a) && Nn(t, a, this.b[a]);
            return (
              this.h ? Nn(t, "tid", this.h) : Hn(t.b, "tid"),
              this.f ? Nn(t, "eid", this.f) : Hn(t.b, "eid"),
              (a = iu(this.c)).length && Nn(t, "fw", a.join(",")),
              t.toString()
            );
          }),
          ...
          (t.Nb = function (t, e, n, i) {
            ...
            return this.a
              .then(function () {
                Oo(e),
                  ti(
                    uu(r.s, r.g, r.b, t, e, Qn(), n, r.c, void 0, r.i, i, r.f)
                  );
              })
              .o(function (t) {
                throw (
        ...
        function bu() {
          ...
          ci() && self
            ? ((this.v =
                ...
                e || ((e = new hu(n)), fu.push(e)),
                e)),
              du(this.v, "keyChanged", function (t, n) {
        ...
        function Ru() {
          ...
          (this.a = Du() || zl.default.INTERNAL.node.localStorage),
        ...
        function Lu() {
          ...
          (this.a = xu() || zl.default.INTERNAL.node.sessionStorage),
        ...
        function Ju(t, e, n) {
          return (
            (n = Xu(e, n)), "local" == e.F && (t.b[n] = null), Wu(t, e.F).U(n)
          );
        }
        function Yu(t) {
        ...
        ((t = Gu.prototype).get = function (t, e) {
          ...
          (t.removeListener = function (t, e, n) {
            (t = Xu(t, e)),
              ...
              ut(this.a) && (Wu(this, "local").ia(this.f), Yu(this));
          }),
          (t.Yb = function (t) {
            if (t && t.g) {
              var e = t.a.key;
              if (null == e)
                ...
                if (
                  (void 0 !== t.a.a ? Wu(this, "local").ia(this.f) : Yu(this),
                  this.m)
                )
                  if (
                ...
                var o = this,
                  n = function () {
                    (void 0 === t.a.a &&
                      ...
                      ((o.b[e] = l.localStorage.getItem(e)), o.mb(e));
                  };
                Ht &&
                Zt &&
                10 == Zt &&
        ...
        function tc(t, e) {
          (this.b = ec),
            ...
            void 0 === $u && ($u = l.Int32Array ? new Int32Array(uc) : uc),
            this.reset();
        }
        w(tc, function () {
          this.b = -1;
                    ...
                    (t = !0),
                      ...
                      mc(r).then(function (t) {
                        ...
                        t &&
                          ...
                          (n =
                            (e =
                              -1 != (n = Jr(i.url)).indexOf("/__/auth/callback")
                                ? (e =
                                    "object" ==
                                    typeof (e = Si(
                                      _n((e = On(n)), "firebaseError") || null
                                    ))
                                      ? E(e)
                                      : null)
                                  ? new Co(t.c, t.b, null, null, e, null, t.T())
                                  : new Co(t.c, t.b, n, t.f, null, null, t.T())
                                : e) || o)),
                          pc(r, n);
                      });
                  }
                      ...
                      if (
                        (0 ==
                          t
                            .toLowerCase()
                            .indexOf(
                              bi("BuildInfo.packageName", l).toLowerCase() +
                                "://"
                            ) && e({ url: t }),
                        "function" == typeof i)
                      )
                    ...
                    (function (t) {
                      ...
                      n.a.push(t),
                        n.b ||
                          ...
                          "function" ==
                            typeof (t = bi("universalLinks.subscribe", l)) &&
                            t(null, n.b));
                    })(e);
                });
              })),
        ...
        ((t = lc.prototype).ma = function () {
          return (
            ...
            (this.Ia = (si(void 0)
              ...
              function () {
                if ("function" != typeof bi("universalLinks.subscribe", l))
                  throw fc(
                    "cordova-universal-links-plugin-fix is not installed"
                  );
                if (void 0 === bi("BuildInfo.packageName", l))
                  throw fc("cordova-plugin-buildinfo is not installed");
                if (
                  "function" !=
                  typeof bi("cordova.plugins.browsertab.openUrl", l)
                )
                  throw fc("cordova-plugin-browsertab is not installed");
                if ("function" != typeof bi("cordova.InAppBrowser.open", l))
                    ...
                    .then(function () {
                      ...
                      t(function (t) {
                        if (t) {
                          ...
                          if (
                            "function" !=
                            typeof (e = bi("cordova.InAppBrowser.open", l))
                          )
                            throw new T("invalid-cordova-configuration");
                          (t = gi()),
                            (n.a = e(
        ...
        function wc(t, e, n, i) {
          (this.i = {}),
            ...
            (this.b = new xc()),
            (this.C = new Fc()),
            (this.g = new gc(Pc(this.v, this.m))),
            (this.c = {}),
            ...
            (this.a = Ic(this.D, this.v, this.m, A, this.J));
        }
        ...
        (wc.prototype.reset = function () {
          (this.f = !1),
            this.a.Sa(this.l),
            (this.a = Ic(this.D, this.v, this.m, null, this.J)),
            (this.i = {});
        }),
        ...
        function Bc(t, e, n) {
          ...
          V(e[Wc] || [], function (t) {
            ...
            Vi(this, "auth", this.a),
            Vi(this, "session", this.c),
            Vi(this, "hints", this.b);
        }
        ...
        function Zc(t) {
          if (($c.call(this, t), this.a.fa != So.PROVIDER_ID))
            throw new T(
              "argument-error",
        ...
        function Qc(t, e) {
          for (var n in (Fe.call(this, t), e)) this[n] = e[n];
        }
        function th(t, e) {
          (this.a = t),
            (this.b = []),
          ...
          e &&
            ...
            V(e.multiFactor.enrolledFactors, function (t) {
              ...
              if (t) {
                t.uid && (n[Xi] = t.uid),
                  t.displayName && (n[Bi] = t.displayName),
                  t.enrollmentTime &&
                    (n[Wi] = new Date(t.enrollmentTime).toISOString()),
                  t.phoneNumber && (n[Ji] = t.phoneNumber);
                try {
                  e = new Yi(n);
                } catch (t) {}
                t = e;
        ...
        function ah(t, e) {
          (t.b = Pr(e[Ha] || "")),
            (t.a = e.refreshToken),
            oh(t, void 0 !== (e = e.expiresIn) ? Number(e) : void 0);
        }
        function sh(e, t) {
          return (
            (i = e.f),
        ...
        function hh(t, e, n) {
          ...
          (this.a = new Fa(this.l, _(A), r)),
            t.emulatorConfig && Ja(this.a, t.emulatorConfig),
            (this.b = new rh(this.a)),
            bh(this, e[Ha]),
            ah(this.b, e),
            Vi(this, "refreshToken", this.b.a),
            Ih(this, n || {}),
            ln.call(this),
            (this.R = !1),
            this.s && wi() && (this.i = Lc(this.s, this.l, this.m)),
            (this.S = []),
            (this.h = null),
            (this.u =
              ((i = this),
          ...
          (this.ya = null),
            ...
            Vi(this, "multiFactor", this.O);
        }
        function lh(t, e) {
          t.ja && en(t.ja, "languageCodeChanged", t.Oa),
            (t.ja = e) && Ze(e, "languageCodeChanged", t.Oa);
        }
        function fh(t, e) {
          t.X && en(t.X, "emulatorConfigChanged", t.Aa),
            (t.X = e) && Ze(e, "emulatorConfigChanged", t.Aa);
        }
        function dh(t, e) {
          (t.$ = e),
            za(
              t.a,
              zl.default.SDK_VERSION ? mi(zl.default.SDK_VERSION, t.$) : null
            );
        }
        function ph(t, e) {
          t.ba && en(t.ba, "frameworkChanged", t.Ba),
            (t.ba = e) && Ze(e, "frameworkChanged", t.Ba);
        }
        function vh(e) {
          try {
        ...
        function mh(t) {
          t.D ||
            t.u.b ||
            (t.u.start(),
            en(t, "tokenChanged", t.aa),
            Ze(t, "tokenChanged", t.aa));
        }
        function gh(t) {
        ...
        function _h(e, t) {
          ...
          e != t &&
            ...
            t.metadata
              ? Vi(e, "metadata", new uh((i = t.metadata).a, i.b))
              : Vi(e, "metadata", new uh()),
        ...
        function Ch(t, e) {
          e[Ha] &&
            t.za != e[Ha] &&
            (ah(t.b, e),
            t.dispatchEvent(new Qc("tokenChanged")),
            bh(t, e[Ha]),
            Nh(t, "refreshToken", t.b.a));
        }
        function Rh(t, e) {
          return Oh(t).then(function () {
            if (K(Ah(t), e))
              return yh(t).then(function () {
                ...
                : t.o(function (t) {
                    throw (
                      (!t ||
                        ...
                        (i.h || i.dispatchEvent(new Qc("userInvalidated")),
                        (i.h = t)),
                      t)
                    );
                  }));
        ...
        function Uh(t) {
          ...
          (n[Ha] = t.stsTokenManager.accessToken),
        ...
        (Bc.prototype.Rc = function (t) {
          ...
          w(Jc, T),
          (zc.prototype.sb = function (t, e, n) {
            return e.type == zr
              ? ((o = this),
                (a = t),
                (s = n),
                e.Ha().then(function (t) {
                  return (
                    ...
                    lt(t, { phoneVerificationInfo: ko(o.a) }),
                    Xs(a, Ts, t)
                  );
                }))
              : ((i = this),
          ...
          Vi(hh.prototype, "providerId", "firebase"),
          ((t = hh.prototype).reload = function () {
            var t = this;
            return jh(
              this,
              Eh(this).then(function () {
                return Oh(t)
                  .then(function () {
                    return yh(t);
                  })
              ...
              Eh(this)
                ...
                .then(function (t) {
                  ...
                  return (
                    t.accessToken != e.za &&
                      (bh(e, t.accessToken),
                      e.dispatchEvent(new Qc("tokenChanged"))),
                    Nh(e, "refreshToken", t.refreshToken),
                    t.accessToken
                  );
                })
            );
          ...
          (t.Kc = function (t) {
            ...
            Nh(
              ...
              this.dispatchEvent(new Qc("userReloaded", { hd: t }));
          }),
          (t.Lc = function (t) {
            return (
              ji(
            ...
            return jh(
              ...
              this.I()
                ...
                .then(function (t) {
                  return (
                    Ch(n, t),
                    Nh(n, "displayName", t.displayName || null),
                    Nh(n, "photoURL", t.photoUrl || null),
                    V(n.providerData, function (t) {
                      "password" === t.providerId &&
                        (Vi(t, "displayName", n.displayName),
                        Vi(t, "photoURL", n.photoURL));
                    }),
                    yh(n)
                  );
                })
                  ...
                  ? Xs(n.a, ys, { idToken: t, deleteProvider: [e] }).then(
                      function (t) {
                        ...
                        return (
                          ...
                          e[So.PROVIDER_ID] || Vi(n, "phoneNumber", null),
                          yh(n)
                        );
                      }
                    )
          ...
          (t.delete = function () {
            ...
            return jh(
              ...
              for (var t = 0; t < e.J.length; t++) e.J[t].cancel("app-deleted");
              lh(e, null),
                fh(e, null),
                ph(e, null),
                (e.J = []),
        ...
        var Fh = { name: "redirectUser", F: "session" };
        function qh(t) {
                    ...
                    : e.b.get(r, e.a).then(function (t) {
                        return t
                          ...
                          : e.b.get(n, e.a).then(function (t) {
                              return t
                                ? n
                                : e.b.get(Gh, e.a).then(function (t) {
                                    return t ? Bh(t) : n;
                                  });
                            });
                      });
        ...
        function Kh(t, e) {
          var n,
            s,
            i = [];
          for (n in Ku) Ku[n] !== e && i.push(Ju(t.b, Bh(Ku[n]), t.a));
          return (
            i.push(Ju(t.b, Gh, t.a)),
            (s = i),
            new fe(function (n, e) {
              var i = s.length,
                r = [];
        ...
        function zh(t) {
          if (
            ((this.l = !1),
            Vi(this, "settings", new qc()),
            Vi(this, "app", t),
            !this.app.options || !this.app.options.apiKey)
          )
            throw new T("invalid-api-key");
          var n, e, i, r, o, a;
          (t = zl.default.SDK_VERSION ? mi(zl.default.SDK_VERSION) : null),
            (this.a = new Fa(
              this.app.options && this.app.options.apiKey,
              _(A),
              t
            ...
            (this.s = []),
            (this.O = []),
            (this.hb = zl.default.INTERNAL.createSubscribe(b(this.zc, this))),
            (this.X = void 0),
            (this.bc = zl.default.INTERNAL.createSubscribe(b(this.Ac, this))),
            il(this, null),
            (this.i = new Hh(this.app.options.apiKey + ":" + this.app.name)),
            (this.D = new Vh(this.app.options.apiKey + ":" + this.app.name)),
            (this.$ = ul(
              this,
            ...
            (this.h = ul(
              ...
              (i = this).$.then(function () {
                ...
                .then(function () {
                  ...
                  i.l ||
                    ((i.ba = !0),
                    (t = i.i).b.addListener(Bh("local"), t.a, i.ja));
                })
            )),
            (this.ba = !1),
            (this.ja = b(this.Zc, this)),
            (this.Ba = b(this.da, this)),
            (this.ya = b(this.mc, this)),
              ...
              get: function () {
                ...
                return (t = this.P
                  ? qi({
                      ...
                      host: t.a,
                      port: t.g,
                      options: qi({ disableWarnings: this.P.ec }),
                    })
                  : null);
              },
              enumerable: !1,
        ...
        function il(t, e) {
          ...
          ol(t) &&
            ...
            en(ol(t), "tokenChanged", t.ya),
            en(ol(t), "userDeleted", t.za),
            en(ol(t), "userInvalidated", t.Aa),
            gh(ol(t))),
            e &&
              (e.S.push(t.Ba),
        ...
        function sl(t) {
          if (t.ba) {
            for (var e = 0; e < t.s.length; e++) t.s[e] && t.s[e](al(t));
        ...
        (Hh.prototype.xb = function (e) {
          ...
          (t.wa = function (t) {
            this.aa === t ||
              ...
              ((this.aa = t),
              Xa(this.a, this.aa),
              this.dispatchEvent(new $h(this.la())));
          }),
          (t.la = function () {
            return this.aa;
          }),
          ...
          (t.gd = function (t, e) {
            if (!this.P) {
              ...
              (e = !!e && !!e.disableWarnings),
                ...
                (this.settings.ib = !0),
                Ja(this.a, this.P),
                this.dispatchEvent(new Zh(this.P));
            }
            var n;
          }),
          (t.Gc = function (t) {
            this.J.push(t),
              za(
                ...
                zl.default.SDK_VERSION
                  ? mi(zl.default.SDK_VERSION, this.J)
                  : null
              ),
              this.dispatchEvent(new Qh(this.J));
          }),
          (t.Ga = function () {
            return X(this.J);
          }),
                ...
                .then(function () {
                  return new fe(function (t, e) {
                    n.na(
                      ...
                      (n.C = e),
                      (n.g = i),
                      (n.c = Rc(n.b, n, "signInViaPopup", o, i));
                  });
                })
                .then(function (t) {
            ...
            return (
              this.ba &&
                Promise.resolve().then(function () {
                  "function" == typeof t
                    ? t(ol(i))
                    : "function" == typeof t.next && t.next(ol(i));
                }),
              this.hb(t, e, n)
            );
          }),
          ...
          (t.Uc = function (t, e) {
            var n = this;
            return this.h.then(function () {
              return rl(n, Xs(n.a, Hs, { email: t, password: e }));
            });
          }),
          (t.dc = function (t, e) {
            var n = this;
            return this.h.then(function () {
              return rl(n, Xs(n.a, ms, { email: t, password: e }));
            });
          }),
          (t.$a = function (t) {
            var e = this;
          ...
          (t.zb = function () {
            ...
            return this.h.then(function () {
              var t = ol(n);
              if (t && t.isAnonymous) {
                var e = qi({ providerId: null, isNewUser: !1 });
                return qi({
                  user: t,
                  credential: null,
          ...
          (t.delete = function () {
            ...
            return (
              (this.R = []),
              this.i &&
                (t = this.i).b.removeListener(Bh("local"), t.a, this.ja),
              this.b && (kc(this.b, this), jc(this.b.b)),
              Promise.resolve()
            );
          }),
          (t.hc = function (t) {
              ...
              ye()
                .then(function () {
                  ...
                  if (!t.c)
                    throw new T(
                      "argument-error",
                      Tr + " must be true when sending sign in link to email"
                    );
                  return Or(t);
                })
                .then(function (t) {
          ...
          (cl.prototype.getResponse = function () {}),
          (cl.prototype.execute = function () {});
        var ll = null;
        function fl(t, e) {
        ...
        (hl.prototype.render = function (t, e) {
          ...
          (pl.prototype.delete = function () {
            vl(this),
              ...
              clearTimeout(this.a),
              (this.a = null),
              en(this.f, "click", this.i);
          }),
          Vi(ml, "FACTOR_ID", "phone"),
          ...
          return new fe(function (t, e) {
            ...
            !l.grecaptcha || (r !== o.f && !o.b)
              ? ((l[o.a] = function () {
                ...
                ye(Pa(It(wl, { onload: o.a, hl: r || "" }))).o(function () {
                  clearTimeout(i),
                    e(
                      new T(
                        "internal-error",
        ...
        function El(t, e, n, i, r, o, a) {
          if (
            (Vi(this, "type", "recaptcha"),
            (this.c = this.f = null),
            (this.D = !1),
            (this.v = e),
            (this.g = null),
            (a = a ? (bl = bl || new gl()) : (Tl = Tl || new yl())),
            (this.m = a),
          ...
          if (((this.i = "invisible" === this.a[Nl]), !l.document))
            throw new T(
              "operation-not-supported-in-this-environment",
        ...
        function Rl(t, e, n) {
          ...
          (o = zl.default.SDK_VERSION ? mi(zl.default.SDK_VERSION, o) : null),
            El.call(
              this,
              n,
              t,
        ...
        Wl(zh.prototype, {
          jb: { name: "applyActionCode", j: [Ll("code")] },
          Ra: { name: "checkActionCode", j: [Ll("code")] },
          nb: {
          ...
          hc: { name: "fetchSignInMethodsForEmail", j: [Ll("email")] },
          qa: { name: "getRedirectResult", j: [] },
          Bc: { name: "isSignInWithEmailLink", j: [Ll("emailLink")] },
          Hc: {
            name: "onAuthStateChanged",
            j: [
              Bl(Ml(), jl(), "nextOrObserver"),
              jl("opt_error", !0),
              jl("opt_completed", !0),
            ],
          },
          ...
          xb: { name: "setPersistence", j: [Ll("persistence")] },
          Sc: { name: "signInAndRetrieveDataWithCredential", j: [Vl()] },
          zb: { name: "signInAnonymously", j: [] },
          $a: { name: "signInWithCredential", j: [Vl()] },
          Tc: { name: "signInWithCustomToken", j: [Ll("token")] },
          Uc: {
          ...
          Wc: { name: "signInWithPhoneNumber", j: [Ll("phoneNumber"), Gl()] },
          Xc: { name: "signInWithPopup", j: [ql()] },
          Yc: { name: "signInWithRedirect", j: [ql()] },
          dd: {
          ...
          gd: { name: "useEmulator", j: [Ll("url"), Ml("options", !0)] },
          jd: { name: "verifyPasswordResetCode", j: [Ll("code")] },
        }),
          Xl(zh.prototype, {
            lc: { name: "languageCode", kb: Bl(Ll(), Ul(), "languageCode") },
            ti: { name: "tenantId", kb: Bl(Ll(), Ul(), "tenantId") },
          }),
          ((zh.Persistence = Ku).LOCAL = "local"),
          (zh.Persistence.SESSION = "session"),
          (zh.Persistence.NONE = "none"),
          Wl(hh.prototype, {
            delete: { name: "delete", j: [] },
            oc: { name: "getIdTokenResult", j: [xl("opt_forceRefresh", !0)] },
            I: { name: "getIdToken", j: [xl("opt_forceRefresh", !0)] },
            Cc: { name: "linkAndRetrieveDataWithCredential", j: [Vl()] },
            qb: { name: "linkWithCredential", j: [Vl()] },
            Dc: { name: "linkWithPhoneNumber", j: [Ll("phoneNumber"), Gl()] },
            Ec: { name: "linkWithPopup", j: [ql()] },
            Fc: { name: "linkWithRedirect", j: [ql()] },
            Lc: {
              name: "reauthenticateAndRetrieveDataWithCredential",
              j: [Vl()],
            },
            tb: { name: "reauthenticateWithCredential", j: [Vl()] },
            Mc: {
              name: "reauthenticateWithPhoneNumber",
              j: [Ll("phoneNumber"), Gl()],
            },
            Nc: { name: "reauthenticateWithPopup", j: [ql()] },
            Oc: { name: "reauthenticateWithRedirect", j: [ql()] },
            ...
            toJSON: { name: "toJSON", j: [Ll(null, !0)] },
            cd: { name: "unlink", j: [Ll("provider")] },
            Bb: { name: "updateEmail", j: [Ll("email")] },
            Cb: { name: "updatePassword", j: [Ll("password")] },
            ed: { name: "updatePhoneNumber", j: [Vl("phone")] },
            Db: { name: "updateProfile", j: [Ml("profile")] },
            Eb: {
          ...
          Wl(bo.prototype, { w: { name: "toJSON", j: [Ll(null, !0)] } }),
          Wl(co.prototype, {
          ...
          Jl(co, "credential", ho, [Bl(Ll(), Ml(), "token")]),
          Jl(wo, "credentialWithLink", Io, [Ll("email"), Ll("emailLink")]),
          Wl(lo.prototype, {
            Ca: { name: "addScope", j: [Ll("scope")] },
            Ka: {
              name: "setCustomParameters",
          ...
          Jl(lo, "credential", fo, [Bl(Ll(), Ml(), "token")]),
          Wl(po.prototype, {
            Ca: { name: "addScope", j: [Ll("scope")] },
            Ka: {
              name: "setCustomParameters",
          ...
          Jl(po, "credential", vo, [
            Bl(Ll(), Bl(Ml(), Ul()), "idToken"),
            Bl(Ll(), Ul(), "accessToken", !0),
          ]),
          Wl(mo.prototype, {
            Ka: {
              name: "setCustomParameters",
          ...
          Jl(mo, "credential", go, [Bl(Ll(), Ml(), "token"), Ll("secret", !0)]),
          Wl(uo.prototype, {
            Ca: { name: "addScope", j: [Ll("scope")] },
            credential: {
              name: "credential",
              j: [
                Bl(Ll(), Bl(Ml(), Ul()), "optionsOrIdToken"),
                Bl(Ll(), Ul(), "accessToken", !0),
              ],
            },
            Ka: {
          ...
          Wl(io.prototype, { w: { name: "toJSON", j: [Ll(null, !0)] } }),
          Wl(to.prototype, { w: { name: "toJSON", j: [Ll(null, !0)] } }),
          Jl(So, "credential", No, [
            Ll("verificationId"),
            Ll("verificationCode"),
          ]),
                    ...
                    M: function (t) {
                      return (
                        ...
                        (t.session && t.phoneNumber
                          ...
                          ? Hl(t.session, $r) && Kl(t.multiFactorHint)
          ...
          Wl(Eo.prototype, { w: { name: "toJSON", j: [Ll(null, !0)] } }),
          Wl(T.prototype, { toJSON: { name: "toJSON", j: [Ll(null, !0)] } }),
          Wl(Mo.prototype, { toJSON: { name: "toJSON", j: [Ll(null, !0)] } }),
          Wl(xo.prototype, { toJSON: { name: "toJSON", j: [Ll(null, !0)] } }),
          Wl(Jc.prototype, { toJSON: { name: "toJSON", j: [Ll(null, !0)] } }),
          Wl(Bc.prototype, { Rc: { name: "resolveSignIn", j: [Fl()] } }),
          Wl(th.prototype, {
            Rb: { name: "getSession", j: [] },
            fc: { name: "enroll", j: [Fl(), Ll("displayName", !0)] },
            bd: {
              name: "unenroll",
              j: [
                Bl(
          ...
          (function () {
            ...
            Jl(t, "EmailAuthProvider", wo, []),
              Jl(t, "FacebookAuthProvider", co, []),
              Jl(t, "GithubAuthProvider", lo, []),
              Jl(t, "GoogleAuthProvider", po, []),
              Jl(t, "TwitterAuthProvider", mo, []),
              Jl(t, "OAuthProvider", uo, [Ll("providerId")]),
              Jl(t, "SAMLAuthProvider", so, [Ll("providerId")]),
              Jl(t, "PhoneAuthProvider", So, [
                {
                  name: "auth",
              ...
              Jl(t, "ActionCodeURL", hr, []),
              Jl(t, "PhoneMultiFactorGenerator", ml, []),
              zl.default.INTERNAL.registerComponent({
                name: "auth",
              ...
              zl.default.registerVersion("@firebase/auth", "0.16.4"),
              zl.default.INTERNAL.extendNamespace({ User: hh });
          })();
      }.apply(
