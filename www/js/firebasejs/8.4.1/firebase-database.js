  ...
  try {
    !function () {
      ...
      var He =
        ...
        Ve);
      function Ve() {}
      var ze = /(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,
        Qe = "websocket",
        Ye = "long_polling",
        Ke =
              ...
              this.authTokenProvider_
                ...
                .then(null, function (e) {
                  o.log_("Failed to get token: " + e),
                    s || (h.repoInfo_.nodeAdmin && Ne(e), l());
                }));
          }),
      ...
      var ls =
        ...
        (hs.prototype.matches = function (t) {
          var n = this;
          if (t instanceof hs) {
      ...
      function cs(n, e, t, r, i) {
        ...
        "object" == typeof r && ((s = void 0), (i = r)),
          ...
          i &&
            i.onlyOnce &&
            (((i = function (e, t) {
              o(e, t), Ea(n._repo, n, u);
            }).userCallback = (o = t).userCallback),
            (i.context = t.context),
            (t = i));
        var a,
          s = new Ua(t, s || void 0),
          u = "value" === e ? new ss(s) : new ls((((a = {})[e] = s), a));
        return (
          (e = n._repo),
          (s = u),
          (s =
            ".info" === kt((a = n)._path)
              ? co(e.infoSyncTree_, a, s)
              : co(e.serverSyncTree_, a, s)),
          aa(e.eventQueue_, a._path, s),
          function () {
            return Ea(n._repo, n, u);
          }
        );
      }
      function ds(e, t, n, r) {
      ...
      ct((Pu = t.default).SDK_VERSION),
        ...
        Pu.registerVersion("@firebase/database", "0.9.10");
    }.apply(this, arguments);
  } catch (e) {
    throw (
      (console.error(e),
